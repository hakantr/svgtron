...
const I = (d: TemplateResult) =>
  svg`<svg viewBox="0 0 18 18" width="16" height="16" fill="currentColor">${d}</svg>`;
...
const IKON: Record<HizalaModu, TemplateResult> = {
  sol: I(
    svg`<rect x="1" y="2" width="1.4" height="14"/><rect x="3.5" y="4" width="9" height="3" rx="1"/><rect x="3.5" y="11" width="6" height="3" rx="1"/>`,
  ),
  "yatay-merkez": I(
    svg`<rect x="8.3" y="2" width="1.4" height="14"/><rect x="4" y="4" width="10" height="3" rx="1"/><rect x="5.5" y="11" width="7" height="3" rx="1"/>`,
  ),
  sag: I(
    svg`<rect x="15.6" y="2" width="1.4" height="14"/><rect x="5.5" y="4" width="9" height="3" rx="1"/><rect x="8.5" y="11" width="6" height="3" rx="1"/>`,
  ),
  ust: I(
    svg`<rect x="2" y="1" width="14" height="1.4"/><rect x="4" y="3.5" width="3" height="9" rx="1"/><rect x="11" y="3.5" width="3" height="6" rx="1"/>`,
  ),
  "dikey-orta": I(
    svg`<rect x="2" y="8.3" width="14" height="1.4"/><rect x="4" y="4" width="3" height="10" rx="1"/><rect x="11" y="5.5" width="3" height="7" rx="1"/>`,
  ),
  alt: I(
    svg`<rect x="2" y="15.6" width="14" height="1.4"/><rect x="4" y="5.5" width="3" height="9" rx="1"/><rect x="11" y="8.5" width="3" height="6" rx="1"/>`,
  ),
  "dagit-yatay": I(
    svg`<rect x="1" y="6" width="3" height="6" rx="1"/><rect x="7.5" y="6" width="3" height="6" rx="1"/><rect x="14" y="6" width="3" height="6" rx="1"/>`,
  ),
  "dagit-dikey": I(
    svg`<rect x="6" y="1" width="6" height="3" rx="1"/><rect x="6" y="7.5" width="6" height="3" rx="1"/><rect x="6" y="14" width="6" height="3" rx="1"/>`,
  ),
};

const MODLAR: HizalaModu[] = [
  "sol",
  "yatay-merkez",
  "sag",
  "ust",
...
const REFERANSLAR: HizalaReferans[] = [
  "son-secilen",
  "anahtar",
  "secim",
  "belge",
...
export class HizalamaPaneli extends LitElement {
  ...
  #yolOgeleri() {
    return (
      menuKayitDefteri.gruplar().find((g) => g.grup === "yol")?.ogeler ?? []
    );
  }
    ...
    return html`
      ...
      <div class="referans" title=${t("hizala.referans.ipucu")}>
        ...
        <select
          ...
          @change=${(e: Event) =>
            hizalaReferans.ayarla(
              (e.target as HTMLSelectElement).value as HizalaReferans,
            )}
        >
          ${REFERANSLAR.map(
            (r) =>
              html`<option value=${r} ?selected=${hizalaReferans.mod === r}>
                ${t(`hizala.ref.${r}`)}
              </option>`,
          )}
        </select>
